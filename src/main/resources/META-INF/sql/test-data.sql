...
insert into orders (amount, create_date, customer_id, product_id)
       values (23, '2017-10-15 19:04:21', '+380997510598', 1);
insert into orders (amount, create_date, customer_id, product_id)
       values (4, '2017-10-15 19:05:34', '+380938181491', 2);
insert into orders (amount, create_date, customer_id, product_id)
       values (5, '2017-10-15 19:07:18', '+380657550989', 1);
insert into orders (amount, create_date, customer_id, product_id)
       values (16, '2017-10-15 19:09:02', '+380503222345', 2);
--
-- insert into customer (phone_number, orders_id, name, surname, email, reg_date)
