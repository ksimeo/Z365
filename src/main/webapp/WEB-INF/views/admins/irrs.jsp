...
<div class="container">
  ...
  <table class="table table-striped">
    ...
    <tr>
      <th>#ID</th>
      <th>Наименование способа ирригации</th>
      <th>Коэффициент</th>
      <th>&nbsp;</th>
    </tr>
    </thead>
      ...
      <tr>
        ...
        <td><button type="button" class="btn btn-warning btn-md" data-toggle="modal"
          ...
          <input type="button" value="Удалить" class="btn-danger btn-xs pull-right"
                 onclick="document.location='/admin/irrs/' + ${irr.id} + '/delete'">
                ...
                <div class="modal-body">
                  <form:form class="form-horizontal" method="POST" modelAttribute="irrForm" action="${userActionUrl}">
                    ...
                    <div class="modal-footer">
                      <button type="submit" id="submit" class="btn btn-success btn-md">Добавить новый способ ирригации</button>
  ...
  <div class="modal fade" id="myModal1" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form:form class="form-horizontal" method="POST" modelAttribute="newIrrForm" action="${userActionUrl}">
